...
> ## 🛑 先讀 [下一步_20260904.md](下一步_20260904.md),不要從這頁開始做
>
> **下面的步驟 1~7 在 2026-09-03 已經全部跑完,不要重跑。**
> 2026-09-04 又把 M4/M5 驗證整輪跑完了。目前狀態:
>
> | 線 | 狀態 | 結論 |
> |---|---|---|
> | Re-ID 模型(9/1 登記) | 完成 | 官方 `_train`(40 張、單一相機)訓不出可出貨的外觀模型 |
> | M4/M5 驗證(9/3 登記) | 完成 | 四格全 C 級,誤併 58.84~67.23%(門檻 ≤1%),**架構層問題** |
> | 自建訓練集(9/4 登記) | 程式寫好,**未跑** | dry-run:68,964 張、17/18 身份跨鏡頭 |
>
> 結果在 `docs/CHIRLA_預先登記_20260901.md` §8~§11 與
> `docs/CHIRLA_M4M5驗證_預先登記_20260903.md` §10~§12;
> 過程與坑在 [紀錄/2026-09-03_遠端.md](紀錄/2026-09-03_遠端.md)、
> [紀錄/2026-09-04_遠端.md](紀錄/2026-09-04_遠端.md)。
>
> **報告的材料已經夠了,剩下是整理不是再跑實驗。**
>
> 下面這頁保留原文不動(9/1 定稿的交接單),當作背景與指令參考。
